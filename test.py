...
data_for_test_script = [
  ...
  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."},  #1
  ...
  {"freq":"00029000000", "output_code":0x20, "dialog":"Включен диапазон 28.0 мГц"},  #7

  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."}, #8
  {"freq":"00001829999", "output_code":0x00, "dialog":"Ни один диапазон не включен."},  
  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."},
  {"freq":"00001830000", "output_code":0x00, "dialog":"Включен диапазон 1.8 мГц"},
  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."},
  {"freq":"00001930000", "output_code":0x00, "dialog":"Включен диапазон 1.8 мГц"},
  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."},
  {"freq":"00001939999", "output_code":0x00, "dialog":"Ни один диапазон не включен."},  #15

  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."},  #16
  {"freq":"00003499999", "output_code":0x02, "dialog":"Ни один диапазон не включен."}, 
  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."},
  {"freq":"00003500000", "output_code":0x02, "dialog":"Включен диапазон 3.5 мГц"},  
  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."},
  {"freq":"00003800000", "output_code":0x02, "dialog":"Включен диапазон 3.5 мГц"},
  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."},
  {"freq":"00003899999", "output_code":0x02, "dialog":"Ни один диапазон не включен."}, #23
  
  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."}, #24
  ...
  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."},
  {"freq":"00007199999", "output_code":0x04, "dialog":"Ни один диапазон не включен."},  #31

  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."},  #32
  {"freq":"00013999999", "output_code":0x08, "dialog":"Ни один диапазон не включен."},  
  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."},
  {"freq":"00014000000", "output_code":0x08, "dialog":"Включен диапазон 14.0 мГц"},
  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."},
  {"freq":"00014350000", "output_code":0x08, "dialog":"Включен диапазон 14.0 мГц"},
  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."},
  {"freq":"00014359999", "output_code":0x08, "dialog":"Ни один диапазон не включен."},  #39

  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."}, #40
  ...
  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."},
  {"freq":"00021459999", "output_code":0x10, "dialog":"Ни один диапазон не включен."}, #47

  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."}, #48
  {"freq":"00027999999", "output_code":0x20, "dialog":"Ни один диапазон не включен."},
  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."},
  ...
  {"freq":"00000000000", "output_code":0x00, "dialog":"Ни один диапазон не включен."},
  {"freq":"00029799999", "output_code":0x20, "dialog":"Ни один диапазон не включен."} #55
...
data_for_load_test = [
  ...
  {"count":2, "delay":1},
  ["00001900000", "00003600000", "00007040000", "00014200000", "00021100000", "00029000000", "00000000000"]
]
