...
data_for_test_script = [
  ...
  {"freq":"00001809999", "output_code":0x00, "dialog":"Включен диапазон 3.5 мГц"},  
  ...
  {"freq":"00002001000", "output_code":0x00, "dialog":"Включен диапазон 3.5 мГц"},
  ...
  {"freq":"00007201000", "output_code":0x04, "dialog":"Включен диапазон 21.0 мГц"},
  ...
  {"freq":"00014351000", "output_code":0x08, "dialog":"Включен диапазон 21.0 мГц"}, #20
  ...
  {"freq":"00021451000", "output_code":0x10, "dialog":"Включен диапазон 7.0 мГц."},
  ...
  {"freq":"00029701000", "output_code":0x20, "dialog":"Включен диапазон 14.0 мГц"},
